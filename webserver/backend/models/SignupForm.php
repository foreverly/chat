...
class SignupForm extends Model
{
    ...
    public function rules()
    {
        return [
            ...
            // unique表示唯一性，targetClass表示的数据模型 这里就是说UserBackendModel模型对应的数据表字段username必须唯一
            ['username', 'unique', 'targetClass' => '\backend\models\UserBackendModel', 'message' => '用户名已存在.'],
            ...
            ['email', 'unique', 'targetClass' => '\backend\models\UserBackendModel', 'message' => 'email已经被设置了.'],
