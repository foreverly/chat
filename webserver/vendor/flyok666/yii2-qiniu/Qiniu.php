...
namespace flyok666\qiniu;
use yii\web\HttpException;
/**
 * upload file to qiniu.
 *
 * @author flyok666 <flyok666@qq.com>
 * @version 1.0
 */
...
class Qiniu
{
    ...
    const AREA_HUADONG = 'http://up.qiniu.com';
	const AREA_HUABEI = 'http://up-z1.qiniu.com';
	const AREA_HUANAN = 'http://up-z2.qiniu.com';
    ...
    public function uploadFile($filePath, $key = null, $bucket = '')
    {
        ...
        $ch = curl_init();
        curl_setopt($ch, CURLOPT_URL, $this->area);
